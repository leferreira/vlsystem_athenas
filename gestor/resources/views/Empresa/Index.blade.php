						...
						@foreach($lista as $v)						
							<tr>
                                ...
                                <td align="center">
                                 ...
                                 @if(!$v->plano_preco_id)
                                	<a href="{{route('empresa.criarplano', $v->id)}}" class="d-inline-block btn btn-roxo btn-pequeno" title="Criar Plano de Assinatura"> <i class="fas fa-file-pdf"></i> </a>
                                 @else                                  
                                ...
                                @endif
                                <a href="#" onclick="confirm('Tem Certeza ? você perderá todos os dados da empresa') ? document.getElementById('adespesa{{$v->id}}').submit() : '';" class="d-inline-block btn btn-vermelho btn-circulo btn-pequeno"><i class="fas fa-trash-alt"></i></a>
                                <form action="{{route('empresa.destroy', $v->id)}}" method="POST" id="adespesa{{$v->id}}">
