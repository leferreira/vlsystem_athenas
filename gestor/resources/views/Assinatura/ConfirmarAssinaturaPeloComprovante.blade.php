...
<div class="caixa">
  <div class="thead border-bottom mb-3 p-1">
		<div class="titulo mb-0"><i class="fas fa-plus-circle"></i> Confirmar Assinatura pelo Comprovante</div>
		<div>
   ...
   <div id="tabs">
	  ...
	  <div id="tab-1">
		<div class="p-2">	
			...
			<form action="{{route('comprovante.confirmarAssinaturaPeloComprovante')}}" method="Post">
				@csrf
			...
			<fieldset  class="mb-3">					
					...
					<div class="rows">	
                          ...
                          @endphp
                            ...
                            <div class="col-3 mb-4">
                                    <label class="text-label">Valor Comprovante </label>	
                            ...
                            <div class="col-6">
            					...
            					<input type="submit" class="btn btn-azul2 width-100" value="Confirmar Comprovante e Criar Assinatura">
            				</div>               
