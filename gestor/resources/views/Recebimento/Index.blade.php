...
<section class="caixa">
		<div class="thead border-bottom mb-3 p-1">
			<div class="titulo mb-0">
				<span><i class="fas fa-list-alt"></i> Recebimentos</span>
				<span class="mig"><a href="{{route('index')}}" class="text-azul"> Home </a> <i class="fas fa-angle-double-right text-azul"></i> <b class="text-azul2">Lista de Recebimentos</b></span>
			</div>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="dataTable">
						...
						@foreach($lista as $lancamento)
							<tr>
                               ...
                               <td align="center">
									<a href="{{route('recebimento.show', $lancamento->id)}}" class="btn btn-roxo d-inline-block"><i class="fas fa-eye" title="Visualizar"></i></a>
							   </td>
                            </tr>
						@endforeach 						
						</tbody>
