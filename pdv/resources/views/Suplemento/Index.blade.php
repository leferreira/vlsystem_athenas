		...
		<div class="rows mb-4">	
			<div class="col-12">
					<div class="caixa-titulo py-1 d-flex width-100 justify-content-space-between center-middle">
						<span class="h5  pt-1 mb-0 d-inline-block"><i class="far fa-list-alt"></i> Suplemento do Caixa</span>
			...
			<div class="col-4 mt-2 d-flex pl-4">		
				<div class="border width-100" style="background: #31718e;">
					...
					@csrf
					<div class="">
					<span class="d-block p-2 h4 border-bottom text-branco">Suplemento</span>
                         <div class="rows px-4">                                  
                                <div class="col-12">
