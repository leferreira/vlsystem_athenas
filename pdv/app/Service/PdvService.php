...
class PdvService{
    public  static function home($acao){     
        ...
        $url        = getenv("APP_URL_API"). "pdv/home";        
    ...
    public  static function aplicarCupom($dados){
        ...
        $url        = getenv("APP_URL_API"). "pdv/aplicarCupom";   
    ...
    public  static function excluirCupom($venda_id){
        $dados["empresa_id"]      = session("usuario_pdv_logado")->empresa_id;
        $dados["usuario_uuid"]    = session("usuario_pdv_logado")->uuid;
        $dados["caixa_id"]        = session("usuario_pdv_logado")->caixa_id;
        $dados["venda_id"]        = $venda_id;
        
        $url        = getenv("APP_URL_API"). "pdv/excluirCupom";
