...
function finalizarVenda(id) {
	...
	({
		...
		url: base_url + 'admin/pdvvenda/finalizarVenda' ,
		dataType: 'json',
		beforeSend: function (){
		   giraGira();
	   },
...
function atualizarDadosPagamentos(id){
	$.ajax({
         url: base_url + "admin/pdvvenda/atualizarDadosPagamentos",
         type: "post",
         dataType:"Json",
         data:{
        	 venda_id     		: id ,
 ...
 function inserirDuplicata(){
    ...
    $.ajax({
         url: base_url + "admin/pdvduplicata/inserir",
         type: "post",
         dataType:"Json",
         data:{
        	 venda_id     		: venda_id ,
 ...
 function alterarDuplicata(id){
    ...
    $.ajax({
         url: base_url + "admin/pdvduplicata/salvarAlteracao",
         type: "post",
         dataType:"Json",
         data:{
        	 id     		: id ,
 ...
 function excluirDuplicata(id){	
     $.ajax({
       url: base_url + "admin/pdvduplicata/excluir/" + id ,
       type: "GET",
       data: {  },
       dataType:"Json",
       success: function(data){
