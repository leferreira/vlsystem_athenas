...
$('#addProd').click(() => {
	...
	$.ajax({
         url: base_url + "admin/lojaitempedido" ,
         type: "POST", 
         data: {
			pedido_id		: pedido_id,
...
function atualizarDadosPagamentos(id){
	$.ajax({
         url: base_url + "admin/lojapedido/atualizarDados",
         type: "post",
         dataType:"Json",
         data:{
        	 id     			: id ,
        	 cliente_id			: $('#cliente_id').val(),
        	 codigo_rastreio	: $("#codigo_rastreio").val() ,
        	 status_entrega_id	: $("#status_entrega_id").val(),
			 data_pedido		: $("#data_pedido").val(),
        	 data_pagamento		: $("#data_pagamento").val() ,
        	 data_separacao		: $("#data_separacao").val(),
