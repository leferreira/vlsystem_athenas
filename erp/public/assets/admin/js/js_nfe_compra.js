...
function vincularProduto(id_produto){
	...
	$.ajax({
         url: base_url + "admin/nfeentrada/vincularProduto/" + id_produto + "/" + item_nota_id,
         type: "get",
         dataType:"Json",
         data:{},
         success: function(data){
...
function abrirFormulario(id){
	$.ajax({
         url: base_url + "admin/nfeentrada/buscar/" + id,
         type: "get",
         dataType:"Json",
         data:{},
         success: function(data){
...
function salvarCompleto(){
		...
		$.ajax({
			url: base_url + "admin/nfeentrada/cadastrarProduto",
		   type: "POST",
		   dataType: "json",
		   data:{	
		   		id					: id,
...
function salvarReduzido(id){
		...
		var margem_lucro_id		= $("#margem_lucro_"+id).val();	
