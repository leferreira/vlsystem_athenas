...
class FaturaController extends Controller
{
    ...
    public function confirmarPagamento($id)
    {
        ...
        if($fatura->status_id == config('constantes.status.PAGO')){
    ...
    public function assinar($tipo) {
        ...
        if($tipo=="comprovante"){
            return redirect()->route('admin.fatura.comprovante', $fatura->id);
        }
    ...
    public function comprovante($id) {
        ...
        $dados["mercadoPagoJs"] = true;
        $dados["pagamentos"]    = array();
        return view("Admin.Financeiro.Fatura.EnviarComprovante", $dados);
    }
    ...
    public function detalhe($id)
    {
        ...
        $dados["pagamento"]     = FinPagamento::where("fatura_id",$id)->first();
        $dados["formaPagto"]    = FormaPagto::all();
        $dados["fornecedores"]  = Fornecedor::get();
        $dados["centro_custos"] = CentroCusto::get();
        $dados["pagamentos"] = array();
