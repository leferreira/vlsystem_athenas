...
class DuplicataController extends Controller{ 
    ...
    public function inserir(Request $request){
        ...
        $soma_parcela          = 0;
        Duplicata::where("venda_id", $req["venda_id"])->delete();
      ...
      public function alterar(Request $request){
          $req     = $request->except(["_token","_method"]);
          $qtde = Duplicata::where("venda_id", $req["venda_id"])->count("venda_id");
      ...
      public function listarDuplicata($venda_id){
          $lista = Duplicata::where("venda_id", $venda_id)->get();
          $resultado = array();
          foreach($lista as $l){
              $duplicata          = new \stdClass();
              $duplicata->id      = $l->id;
      ...
      public function excluir($id){ 
          try {
              ...
              $valor_total  = Venda::find($duplicata->venda_id)->valor_venda;
             // $valor_total  = Duplicata::where("venda_id", $duplicata->venda_id)->sum("vDup");
              //exclui o item
              $duplicata->delete();
              $lista      = Duplicata::where("venda_id", $duplicata->venda_id)->get();
      ...
      public function salvar(Request $request){
          ...
          $lista = Duplicata::where("venda_id", $req["venda_id"])->get();
          echo json_encode($lista);
