...
class Orcamento extends Model
{
    ...
    protected $fillable = [
        ...
        'data_orcamento', 'xml_path', 'chave', 'nf', 'situacao','valor_orcamento', 'valor_frete', 
        ...
        'descricao_pag_outros','total_desconto_item','total_seguro','despesas_outras',
        'valor_desconto','valor_liquido','total_desconto_item', 'desconto_valor', 'desconto_per', 'venda_id', 'vendedor_id'
    ];
    ...
    public static function somarTotal($id){
        ...
        $valor_orcamento            = ItemOrcamento::where("orcamento_id", $id)->sum("subtotal_liquido");
        ...
        if($orcamento->desconto_per > 0){
            $orcamento->valor_desconto = $orcamento->desconto_per * $valor_orcamento * 0.01;
        }
        
        $orcamento->valor_orcamento = $valor_orcamento;
        $orcamento->valor_liquido = $valor_orcamento +  $orcamento->valor_frete + $orcamento->despesas_outras + $orcamento->total_seguro - $orcamento->valor_desconto;
        $orcamento->save();
    }
