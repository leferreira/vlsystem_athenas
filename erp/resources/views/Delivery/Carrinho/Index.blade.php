@extends("templates.template_loja2")
@section("conteudo")
...
<div class="base-detalhes">
			...
			<?php $geral = 0; ?>
				@foreach($pedido->itens as $i)							
                   <tr>
					...
					<td align="center"><input type="number" id="{{$i->id}}" value="{{$i->quantidade}}" class="qtd"> </td>
					<td align="center">R$ {{number_format($total, 2, ',', '.')}} </td>
					<td align="center">
						<a href="" class="atualizar"></a>
						<a href="{{route('carrinho.excluir', $i->id)}}" class="excluir"></a>
					</td>
               ...
               <tr class="visible-xs">
				...
				<tr>					
                    <td align="left" colspan="3"><a href="{{route('loja.home')}}" class="btn voltar">Continuar Comprando</a><a></a></td>                               
					<td align="right" colspan="2"><a href="{{route('carrinho.forma_pagamento')}}" class="btn">Finalizar Carrinho</a><a></a></td>  
	...
	<div class="rows">	
		 ...
		 <div class="col-3" style="float:none; margin:0 auto">
		 	<form method="get" action="{{route('carrinho.checkout')}}">
