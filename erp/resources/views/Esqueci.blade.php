<html lang="pt-br">
	...
	<body class="base-login">
		<div class="rows mx-0">
			...
			<h1 class="text-center pb-2 text-uppercase">Enviaremos um email com o link para redefinir sua senha no seu email cadastrado</h1>
			...
			@csrf
			 @if (session('status'))
				...
				<input type="email" name="email" id="email" class="form-campo">
