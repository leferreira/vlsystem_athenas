	...
	<div class="">
	 <div class="caixa">
                ...
                <div class="p-2 pb-0 pt-4 width-100 float-left">
					<div id="tab" style="padding:0!important">
                         <ul class="tabs">
                                ...
                                <li><a href="#tab-2">Destinatário</a></li>
                                ...
                                <li><a href="#tab-8">Autorizados</a></li>
                        </ul>
				...
				<div id="tab-1" class="cx-tab">                                        
					@include("Admin.Nfe.Sistema.TabIdentificacao")
				</div>
				
				<div id="tab-2" class="cx-tab">          
					@include("Admin.Nfe.Sistema.TabDestinatario")
				</div> 
			
				<div id="tab-3" class="cx-tab">									
					@include("Admin.Nfe.Sistema.TabProduto")
				</div>
							
				<div id="tab-4" class="cx-tab">									
					@include("Admin.Nfe.Sistema.TabTotalizadores")			
				</div>

				<div id="tab-5" class="cx-tab">		
					@include("Admin.Nfe.Sistema.TabTransporte")			   
				</div>  

				<div id="tab-6" class="cx-tab">									
					@include("Admin.Nfe.Sistema.TabCobranca")	
				</div> 
				
				<div id="tab-7" class="cx-tab">									
					@include("Admin.Nfe.Sistema.TabAdicionais")	
				</div>			  
				
				<div id="tab-8" class="cx-tab">									
					@include("Admin.Nfe.Sistema.TabAutorizado")	
				</div>        
