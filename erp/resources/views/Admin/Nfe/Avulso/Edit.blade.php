	 ...
	 <div class="caixa">
                ...
                <div class="p-2 pb-0 pt-4 width-100 float-left">
					<div id="tab" style="padding:0!important">
                        ...
                        <script src="{{asset('assets/js/NFE/tabDestinatario_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabIdentificacao_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabDuplicata_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabCobranca_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabAdicionais_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabPagamento_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabExportacao_js.js')}}"></script>	
                        <script src="{{asset('assets/js/NFE/tabAutorizado_js.js')}}"></script>			        
				...
				<div id="tab-9" class="cx-tab">									
					@include("Admin.Nfe.TabPagamento")	
				</div> 
				
				<div id="tab-10" class="cx-tab">									
					@include("Admin.Nfe.TabExportacao")	
				</div> 
...
<!--carregar modal-->
	...
	<div class="window" id="janela_produto">
		<div class="caixa mb-0">
            ...
            @include ("Admin.Nfe.janela.lista_emitente")
            @include ("Admin.Nfe.janela.lista_contato")
