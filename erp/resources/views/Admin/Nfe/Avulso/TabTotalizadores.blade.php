<div class="rows">
    <div class="col-12 my-3">            				
        <input type="button" onclick="salvarRetencaoImpostos()" value="Salvar" class="btn btn-roxo text-uppercase" />
    </div>
</div>
...
<legend class="h5 mb-0 text-left">Totalizadores</legend>										
            ...
            <div class="col-2 pt-1 mt-1"> 
                <input type="button" onclick="calcularImpostos()" value="Calcular" class="btn btn-azul width-100" />                              
             </div>
...
<script src="{{ asset('assets/js/NFE/tabTotalizador_js.js')}}"> </script>