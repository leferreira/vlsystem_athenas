			 ...
			 <div class="caixa">			        
                <div class="rows">                
                        ...
                        <div class="col-2 mt-1 pt-1">
                                ...
                                <input type="button" value="ins" id="btnInserirProdutoSemCalculo" class="btn btn-azul width-100">
                        </div>                                                                                                                    
                </div>
                           ...
                           <tbody id="lista_itens">
                               <?php 
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo $item->orig . $item->CFOP ?></td>                             
                                	...
                                	<td><a href='javascript:;' onclick='excluirProdutoSemCalculo({{$item->id}})'  class='btn btn-outline-vermelho btn-pequeno' title='Excluir'>Excluir</a></td>
                                </tr>
                               <?php } ?>
                       </tbody>
                    </table>
