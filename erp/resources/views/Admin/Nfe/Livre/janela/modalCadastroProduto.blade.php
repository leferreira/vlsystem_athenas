...
?>
<div class="window form alt" id="formularioProduto">
	...
	<span class="d-block h3 border-bottom fw-700">Dados do Produto</span>
		 <div class="rows">
                               ...
                               <div class="col-2 mb-3">
                                ...
                                <div class="col-4 mb-3">
									...
									<div class="group-btn">
                                        <?php $id_categoria = ($produto->categoria_id) ?? null ?>
                                        <select class="form-campo"  id="categoria_id">
                                        
                                          @foreach($categorias as $cat)
                                          	<option value="{{$cat->id}}" {{($cat->id == $id_categoria) ? 'selected': ''}}>{{$cat->categoria}}</option>
                                          @endforeach                                              
                                        </select>
										<a href="javascript:;" onclick="abrirSubCategoria()" class="btn btn-azul btn-circulo ml-1 fas fa-plus" title="Inserir nova categoria"></a>
									</div> 
                                </div>
        ...
        <div class="col-12">
		 ...
		 <div class="tfooter end">
			...
			<input type="button" onclick="inserirProduto()" name="" class="btn btn-azul border-bottom" value="Cadastrar">  
		 </div>
	</div>
</div>