...
<div class="rows">	
                ...
                <div class="caixa">
					...
					<span class="d-flex center-middle h5 mb-0"><i class="far fa-list-alt mr-1"></i> Lista de Compras: {{$fornecedor->razao_social}} </span>
						<div>
							<a href="{{route('admin.compra.create')}}" class="btn btn-azul ml-1 d-inline-block" title="Adicionar novo"><i class="fas fa-plus-circle"></i> </a>
						</div>
					</div>                        
                ...
                <!-- MOSTRA AS OPÇÕES  MostraOpcoes --->
					<div class="col-2 MostraOpcoes" id="opcoes_compra">
						<ul class="cx-opcoes" >
							...
							<li class="financeiro_on"><a href="javascript:;" onclick="verContaPagar()" class="" title="Visualizar Contas a Pagar"><i class="fas fa-dollar-sign"></i> Ver Contas a Pagar</a></li>
								
							<li class="estoque_off"><a href="javascript:;" onclick="lancarEstoque()" class="" title="Visualizar Contas a Pagar"><i class="fas fa-dollar-sign"></i> Lançar Estoque</a></li>
							<li class="estoque_on"><a href="javascript:;" onclick="estornarEstoque()" class="" title="Visualizar Contas a Pagar"><i class="fas fa-dollar-sign"></i> Estornar Estoque</a></li>
							<li class="concreto"><a href="javascript:;" onclick="gerarNotaDevolucaoCompra()"><i class="fas fa-eye"></i> Gerar Nota de Devolução</a></li>
...
function gerarNotaDevolucaoCompra(){
	giraGira();
	location.href = base_url + "admin/notafiscal/gerarNotadevolucaoCompra/" + compra_id;	
}
