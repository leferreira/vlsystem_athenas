...
<div class="rows">	
                ...
                <div class="caixa">
					...
					<span class="d-flex center-middle h5 mb-0"><i class="far fa-list-alt mr-1"></i> Filtro para Impressão - Produto </span>
						<div>
					...
					<form name="busca" action="{{route('admin.produto.relatorioSintetico')}}" method="get">                        
                        <div class="px-2 pt-2">
