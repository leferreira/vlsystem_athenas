...
<div class="rows">	
                ...
                <div class="caixa">
					...
					<span class="d-flex center-middle h5 mb-0"><i class="far fa-list-alt mr-1"></i> Consultas Recebimentos </span>
						<div>
					...
					<form name="busca" method="get">                        
                        <div class="px-2 pt-2">
							  ...
							  <div class="rows">							  			
                                        ...
                                        <div class="col-3">	
                                                <label class="text-label d-block text-branco">Dta Recebimento 01 </label>
                                                <input type="date" name="recebimento01" value="{{$filtro->recebimento01 ?? ''}}" class="form-campo">
                                        </div>
                                        <div class="col-3">	
                                                <label class="text-label d-block text-branco">Dta Recebimento 02 </label>
                                                <input type="date" name="recebimento02" value="{{$filtro->recebimento02 ?? ''}}" class="form-campo">
                                        </div>
                                        ...
                                        <div class="col-3">	
                                         ...
                                         <div class="col-3">	
                                            ...
                                            <select class="form-campo" name="tipo_relatorio">
                                            	...
                                            	<option value="agrupado_por_recebimento" >Agrupado por Data Recebimento</option>
                                            	<option value="resumo_por_forma_pagamento" >Resumo por Forma Pagamento</option>
                                            </select>
                                        </div>
