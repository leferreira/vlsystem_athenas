	...
	<div class="">
	 <div class="caixa">
        <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
                <span class="h5  pt-1 mb-0 d-inline-block"><i class="far fa-list-alt"></i> Nova NFCE <span class="text-orange"></span></span>
        </div>
                    
	<form action="{{route('admin.notanfce.criarNota')}}" method="post">
	@csrf
				<div class="rows">	
                <div class="col-12">               
                  ...
                  <div class="col-4 mb-3">
                     <label class="text-label">Natureza Operação<span class="text-vermelho">*</span></label>
						<div class="group-btn">
							...
							<a href="{{route('admin.naturezaoperacao.create')}}"  class="btn btn-azul btn-circulo ml-1 fas fa-plus" title="Inserir nova Natureza"></a>
						</div> 
                    </div>                    
