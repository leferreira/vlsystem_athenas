						...
						<table cellpadding="0" cellspacing="0" class="" width="100%">
							...
							<thead>
								<tr class="tbody" style="vertical-align:top">
									<td align="center"><b>TOTALIZAÇÃO DO RELATÓRIO:</b> </td>
									<td align="center"><b>TOTAL CUSTO ATUAL: 70.000,92</b></td>
								</tr>
							</thead>
						</table>
					</td>
	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="6" class="border-bottom" style="text-transform:uppercase;padding:8px 4px;font-size:16px">INVENTÁRIO DE ESTOQUE EM 31/07/2022</th>
					</tr>
					<tr class="thead"> 
						<th align="center" class="border-left">Cód. produto</th> 
						<th align="center" class="border-left">Descrição</th> 
						<th align="center" class="border-left">NCM</th>  
						<th align="center" class="border-left">Tributação</th>										  
						<th align="center" class="border-left">Custo Atual</th>										  
						<th align="center" class="border-left">Estoque</th>															
					</tr>
				</thead>
				
				<tbody class="tbody">					
					<tr> 			
						<td align="center" class="border-left border-top"><p>0000092</p></td>
						<td align="center" class="border-left border-top"><p>COLA INSTANTANEA RENDBOND MOVELEIRO - 100 GR</p>	</td>
						<td align="center" class="border-left border-top"><p>3506.10.10 		</p></td>
						<td align="center" class="border-left border-top"><p>NÃO TRIBUTADO</p></td>				 
						<td align="center" class="border-left border-top"><p>13,93 </p>	</td>	
						<td align="center" class="border-left border-top"><p>23 </p>	</td>				 
					</tr>						
					<tr> 			
						<td align="center" class="border-left border-top"><p>0000092</p></td>
						<td align="center" class="border-left border-top"><p>COLA INSTANTANEA RENDBOND MOVELEIRO - 100 GR</p>	</td>
