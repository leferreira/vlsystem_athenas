	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr>
						<th colspan="6" class="border-bottom" style="text-transform:uppercase;padding:8px 4px;font-size:16px">Listagem de Cliente: '.date('d/m/Y').'</th>
					</tr>
					<tr class="thead">
                ...
                foreach($lista as $p){ 
					$tab .='<tr>
						...
						<td align="center" class="border-left border-top"><p>'.$p->cpf_cnpj.'</p>	</td>
						<td align="center" class="border-left border-top"><p>'.$p->nome_razao_social.'</p></td>
