	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="11" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATÓRIO DE CONTAS A RECEBER<br> <small>(Pag:1)</small></th>
					</tr>
				</thead>
			</table>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				...
				<tbody class="tbody thead">	
					...
					<tr style="text-transform:uppercase">
						<td class="border-bottom" align="left" colspan="11"><p>OBS: 104,00 - 7,00 = 97,00 compra sistemas inteligente</p></td>	
					</tr>
					<tr style="text-transform:uppercase">
