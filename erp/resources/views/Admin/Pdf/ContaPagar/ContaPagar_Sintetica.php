	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="9" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATÓRIO DE MOVIMENTOS <br> <small>Período: '.databr($filtro->data1).' a '.databr($filtro->data2).'</small></th>
					</tr>
				</thead>
			</table>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr class="thead"> 
						...
						<th align="center" class="border-bottom">Data Venda</th> 
						<th align="center" class="border-bottom">Usuário</th> 
						<th align="center" class="border-bottom">Cliente</th>  
						<th align="center" class="border-bottom">Valor</th>										  
						<th align="center" class="border-bottom">Desconto.</th>
						<th align="center" class="border-bottom">Acréscimo</th>
						<th align="center" class="border-bottom">Líquido</th>
					</tr>
				</thead>
				...
				<tbody class="tbody thead">';
                    ...
                    foreach($lista as $l){
                        ...
                        $soma_venda += $l->valor_total;
                        $soma_desconto += $l->valor_desconto;
                        $soma_acrescimo += $acrescimo;
                        $soma_liquido = $soma_venda - $soma_desconto + $soma_acrescimo;
    					$tab.='<tr style="text-transform:uppercase">
    						<td class="border-bottom" align="left">'.$l->id.'</td>
    						<td class="border-bottom" align="center">'.databr($l->data_venda).'</td>
    						<td class="border-bottom" align="center"><p>'.$l->usuario->name.'</p></td>
    						<td class="border-bottom" align="center">'.$l->cliente->nome_razao_social.'</td>				 
    						<td class="border-bottom" align="center"><p>'.formataNumeroBr($l->valor_total).'</p>	</td>	
    						<td class="border-bottom" align="center"><p>'.formataNumeroBr($l->valor_desconto).'</p>	</td>	
    						<td class="border-bottom" align="center"><p>'.formataNumeroBr($acrescimo).'</p>	</td>	
    						<td class="border-bottom" align="center"><p>'.formataNumeroBr($l->valor_venda).'</p></td>	
    					</tr>';
                    }
					$tab.='<tr style="text-transform:uppercase">
						<td class="border-bottom" align="right" colspan="4"><p><b>TOTAIS</b></p></td>
						<td class="border-bottom" align="center"><p><b>'.formataNumeroBr($soma_venda).'	</b></p></td>	
						<td class="border-bottom" align="center"><p><b>'.formataNumeroBr($soma_desconto).'</b></p></td>	
						<td class="border-bottom" align="center"><p><b>'.formataNumeroBr($soma_acrescimo).'</b></p></td>	
						<td class="border-bottom" align="center"><p><b>'.formataNumeroBr($soma_liquido).'</b></p></td>	
					</tr>
