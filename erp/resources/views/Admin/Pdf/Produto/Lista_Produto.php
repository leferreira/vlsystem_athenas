						...
						<table cellpadding="0" cellspacing="0" class="" width="100%">
							...
							<thead>
								<tr class="tbody" style="vertical-align:top">
									...
									<td align="center"><b>TOTAL Valores: </b></td>
								</tr>
							</thead>
						</table>
					</td>
	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr>
						<th colspan="6" class="border-bottom" style="text-transform:uppercase;padding:8px 4px;font-size:16px">Listagem de Produto: '.date('d/m/Y').'</th>
					</tr>
					<tr class="thead">
						...
						<th align="center" class="border-left">Preço</th>
						<th align="center" class="border-left">Unidade</th>
                ...
                foreach($lista as $p){ 
					$tab .='<tr>
						...
						<td align="center" class="border-left border-top"><p>'.$p->nome.'</p>	</td>
						<td align="center" class="border-left border-top"><p>'.$p->ncm.'</p></td>
						<td align="center" class="border-left border-top"><p>'.$p->valor_venda.'</p></td>
						<td align="center" class="border-left border-top"><p>'.$p->unidade.'</p>	</td>
						<td align="center" class="border-left border-top"><p>'.$p->estoque->quantidade.'</p>	</td>
					</tr>';
                }
