	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="9" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATÓRIO DE PAGAMENTO <br> <small>Período: '.databr($filtro->data1).' a '.databr($filtro->data2).'</small></th>
					</tr>
				</thead>
			</table>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr class="thead"> 
                        ...
                        <th align="center" class="border-bottom">Valor Total</th> 														  
				...
				<tbody class="tbody thead">';
                    ...
                    foreach($lista as $l){                       
    					...
    					$tab.='<tr style="text-transform:uppercase">
                            ...
                            <td class="border-bottom" align="left">'.$l->descricao_recebimento.'</td>
    						<td class="border-bottom" align="center">'.databr($l->data_recebimento).'</td>
                            <td class="border-bottom" align="center"><p>'.$l->forma_pagamento->forma_pagto.'</p></td>
                            <td class="border-bottom" align="center">'.formataNumeroBr($l->valor_original).'</td>
                            <td class="border-bottom" align="center"><p>'.$l->juros.'</p></td>
                            <td class="border-bottom" align="center"><p>'.$l->desconto.'</p></td>
                            <td class="border-bottom" align="center"><p>'.$l->multa.'</p></td>                            
    						<td class="border-bottom" align="center"><p>'.formataNumeroBr($l->valor_recebido).'</p>	</td>	
    							
    					</tr>';
                    }
					$tab.='<tr style="text-transform:uppercase">
						<td class="border-bottom" align="right" colspan="4"><p><b>TOTAIS</b></p></td>
						<td class="border-bottom" align="center"><p><b>'.formataNumeroBr($valor_original).'	</b></p></td>
                        <td class="border-bottom" align="center"><p><b>'.formataNumeroBr($juros).'	</b></p></td>	
                        <td class="border-bottom" align="center"><p><b>'.formataNumeroBr($desconto).'	</b></p></td>
                        <td class="border-bottom" align="center"><p><b>'.formataNumeroBr($multa).'	</b></p></td>
                        <td class="border-bottom" align="center"><p><b>'.formataNumeroBr($total).'	</b></p></td>
					</tr>
