	...
	<head>
		...
		<style>
			*{font-family:arial,sans-serif;font-size:12px;padding:0;margin:0}
			...
			.thead th{color:#111;padding:4px!importan;background:#f5f5f5!important;border:0;font-size:9px!important;text-transform:uppercase}			
						...
						<table  cellpadding="0" cellspacing="0" width="100%" border="0">							
							<tr>
								<th align="center" style="padding-bottom:4px;position:relative">
									<small>Codigos de: <b>3 ate:967</b></small>
		...
		<div class="lista">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border" style="margin-bottom:10px">						
				<tr class="tbody thead">
					<th>Cliente</th>
					<td colspan="9" class="border-left">JP MONTEIRO ACESSORIOS DA MODA LTDA.EPP</td>
				</tr>
					<tr class="thead"> 
						<th align="center" class="border-bottom border-top">Vencimento</th> 
						<th align="center" class="border-bottom border-top">Emissão</th> 
						<th align="center" class="border-bottom border-top">Título</th> 
						<th align="center" class="border-bottom border-top">Valor Titulo</th>  
						<th align="center" class="border-bottom border-top">Baixa</th>		
						<th align="center" class="border-bottom border-top">Dt. Baixa</th>
						<th align="center" class="border-bottom border-top">Valor Baixa</th>
						<th align="center" class="border-bottom border-top">Tipo de Recebimento</th>
						<th align="center" class="border-bottom border-top">Total Baixas</th>
						<th align="center" class="border-bottom border-top">Saldo</th>
					</tr>
				
				<tbody class="tbody thead">	
					<tr style="text-transform:uppercase">
						<td class="border-bottom-traco" align="center">11/11/22</td>
						<td class="border-bottom-traco" align="center">11/11/22</td>
						<td class="border-bottom-traco" align="center"> 1-1057/001</td>
						<td class="border-bottom-traco" align="center">87,46</td>
						<td class="border-bottom-traco" align="center">0</td>				 
						<td class="border-bottom-traco" align="center">01/12/2022</td>				 
						<td class="border-bottom-traco" align="center">87,46</td>	
						<td class="border-bottom-traco" align="center"> Boleto/Duplicata</td>	
						<td class="border-bottom-traco" align="center">R$ 1.200,00</td>	
						<td class="border-bottom-traco" align="center">R$ 200,00</td>	
					</tr>
					<tr style="text-transform:uppercase">
						<td class="border-bottom-traco" align="center">11/11/22</td>
						<td class="border-bottom-traco" align="center">11/11/22</td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border" style="margin-bottom:10px">						
				<tr class="tbody thead">
					<th>Cliente</th>
					<td colspan="9" class="border-left"> ASSOCIACAO RECREATIVA DOS EMPREGADOS DOS</td>
				</tr>
					<tr class="thead"> 
						<th align="center" class="border-bottom border-top">Vencimento</th> 
						<th align="center" class="border-bottom border-top">Emissão</th> 
