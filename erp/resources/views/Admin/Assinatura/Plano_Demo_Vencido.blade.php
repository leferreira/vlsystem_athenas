...
<div class="central">
	<div class="conteudo obrigado vencido">
		<div class="rows">
			<div class="col-12 m-auto text-center">
				...
				<span class="d-block text-center h4 text-escuro">Escolha um plano para continuar usando o sistema</span>
			</div>
		</div>
	</div>
	...
	<div class="p-3">
		...
		<div>
			...
			@endphp
			<p>Plano Atual: {{$plano_atual->planopreco->plano->nome ?? "Não existe nenhum atual"}} </p>
		</div>
