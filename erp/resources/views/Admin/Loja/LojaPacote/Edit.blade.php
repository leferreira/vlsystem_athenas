                                    ...
                                    <?php $i = 1 ;?>                               
										@foreach($lista as $l)
											<tr>
                                                ...
                                                <td align="left">{{$l->produto->produto->nome}}</td>
                                                <td align="center">{{$l->quantidade}}</td>
                                                <td align="left">{{$l->produto->produto->valor_venda}}</td>	
                                                <td align="left">{{$l->quantidade * $l->produto->produto->valor_venda}}</td>											
                                                <td align="center">
                									<a class='d-inline-block btn btn-outline-vermelho btn-pequeno' href='javascript:;' onclick='excluirItem({{$l->id}})'>
                            ...
                            <div class="border p-3 radius-4 pb-4">
                                <div class="rows">
                                    <div class="col-6 position-relative">
										...
										<input type="text" id="nome" value="{{$pacote->nome}}" class="form-campo">
									
                                    </div>
                                    <div class="col-2">
										<label class="text-label">Preço Pacote</label>
										<input type="text" id="valor" value="{{$pacote->valor}}" class="form-campo">
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="col-12 mb-3">
                                        ...
                                        <textarea rows="10" cols="150" id="descricao" class="form-campo">{{$pacote->descricao}}</textarea>
                                </div>
