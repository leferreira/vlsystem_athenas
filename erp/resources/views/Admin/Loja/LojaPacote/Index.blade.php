...
<div class="rows">	
           ...
           <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
				<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de Pacotes da Loja </span>
				<div>
					<a href="{{route('admin.lojapacote.create')}}" class="btn btn-azul mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
            ...
            <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    @foreach($lista as $l)
						<tr>
							...
							<td align="center">{{number_format($l->valor, 2, ',', '.')}}</td>
							<td align="center"><a href="{{route('admin.lojapacote.edit', $l->id)}}" class="btn btn-outline-roxo">Editar</a></td>
							 <td align="center">
							<a href="#" onclick="confirm('Tem Certeza?') ? document.getElementById('apagar{{$l->id}}').submit() : '';" class="d-inline-block btn btn-vermelho btn-circulo btn-pequeno"><i class="fas fa-trash-alt"></i></a>
                                    <form action="{{route('admin.lojapacote.destroy', $l->id)}}" method="POST" id="apagar{{$l->id}}">
