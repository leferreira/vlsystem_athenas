...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						...
						<div>
							<a href="{{route('admin.usuario.create')}}" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            <thead>
                                    <tr>
                                       ...
                                       <th align="center" width="70" class="text-center">Usuários</th>
                          ...
                          @foreach($usuarios as $b)                                     
                             <tr>
                                ...
                                <td align="center"> <a href="{{route('admin.usuario.perfis', $b->id)}}" class="btn btn-azul d-inline-block"><i class="fas fa-user"></i> perfil</a> </td>
