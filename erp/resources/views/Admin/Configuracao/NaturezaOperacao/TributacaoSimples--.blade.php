	  ...
	  <div id="tab-1">
		<div class="p-2 mt-3 px-0">			
				<div class="col-12 text-right pb-0 pt-2">
        			<a href="javascript:;" onclick="abrirTelaInserirTributacao()"> + Inserir Tributação </a>
        		</div>
				<fieldset>
                            ...
                            @foreach($natureza->tributacoes as $v)
                            	<tr>
                            		...
                            		<td align="center" width="400">
                            			...
                            			<a href="javascript:;" onclick="editarTributacaoSimples({{$v->id}})" class="btn btn-verde btn-pequeno d-inline-block">Editar</a>
                            		</td>
                            	</tr>
                            @endforeach
							</tbody>
...
@include("Admin.Configuracao.NaturezaOperacao.modalTributacaoSimples")
