                ...
                <div class="rows">	  	
                                    ...
                                    <div class="col-6">
                                        <select class="form-campo" name="solicitacao_id" id="solicitacao_id">
                                            ...
                                            @foreach($abertas as $s)
                                            	<option value="{{$s->id}}">{{$s->insumo->produto}}</option>
                                            @endforeach
                                       </select>
                                    </div>
                                ...
                                <div class="rolagem-tabela">
                                    <table cellpadding="0" cellspacing="0" class="mb-0 table-bordered">
                                        ...
                                        @foreach($solicitacoes as $sol) 
                                             <tr> 
                                                    <td align="center">{{$sol->id}}</td>
                                                    <td align="center">{{$sol->solicitacao->produto->nome}}</td>
                                                    <td align="center">{{$sol->solicitacao->qtde}}</td>
                                                    <td align="center"><a href="javascript:if(confirm('Deseja realmente excluir ? ')){
                                		window.location.href ='{{route('solicitacaocotacao.excluir',['id'=>$sol->id,'idSolicitacao'=>$sol->solicitacao_id])}}'
                                }"  class="link-vermelho"><i class="fas fa-trash-alt h5 mb-0"></i><!-- Excluir--></a>
                                                    </td>
                                            </tr>
                                         @endforeach    	
                                        </tbody>
                    ...
                    <div class="col-6">
                        <div class="caixa mb-3 border mt-3">
                          ...
                          <form action="{{route('fornecedorcotacao.store')}}" name="addFornecedor" id="addFornecedor" method="post" >	   
                            @csrf				
                            <div class="col-12 mb-3">
                            ...
                            <div class="tabela-responsiva sm tborder px-3 pb-3">
                                <div class="rolagem-tabela">
                                    <table cellpadding="0" cellspacing="0" class="mb-0 table-bordered">
                                        ...
                                        @foreach($fornecedores_cotacao as $for) 
                                           <tr class="status-bg"> 
                                                    <td align="center">{{$for->id}}</td>
                                                    <td align="center">{{$for->fornecedor->razao_social}}</td>
                                                    <td align="center">{{$for->fornecedor->email}}</td>	
                                                    <td align="center">{{$for->fornecedor->telefone}}</td>
                                                    <td align="center"><a href="javascript:if(confirm('Deseja realmente excluir ? ')){
                                		window.location.href ='{{route('fornecedorcotacao.excluir',$for->id)}}'
                                }" class="link-vermelho"><i class="fas fa-trash-alt h5 mb-0"></i><!-- Excluir--></a>
                                                    </td>
                                            </tr>
    									@endforeach  
                    ...
                    <div class="col-12 pb-4 pt-3">
                        ...
                        <input type="hidden" name="cotacao_id" value="2">
