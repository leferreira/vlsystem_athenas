...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase  text-branco d-flex justify-content-space-between">
						<span class="d-flex center-middle h5 mb-0"><i class="far fa-list-alt mr-1"></i> Lista de Contas a Pagar da Compra : {{$compra->id}} </span>
						<div class="d-flex">
							<a href="{{ route('admin.contapagar.create')}}" class="btn btn-azul d-inline-block btn-pequeno" title="Adicionar novo"><i class="fas fa-plus-circle"></i></a>
							<a href="{{route('admin.compra.index')}}" class=" ml-1 btn btn-azul btn-pequeno" title="Voltar"><i class="fas fa-arrow-left"></i> </a>
                    ...
                    <table cellpadding="0" cellspacing="0"  width="100%" id="dataTable">
							...
							@foreach($lista as $lancamento)  
                                    <tr>
                                       ...
                                       <td align="center">
											<a href="{{route('admin.contapagar.confirmarPagamento', $lancamento->id)}}" class="btn btn-roxo d-inline-block"><i class="fas fa-dollar-sign" title="Confirmar Pagamento"></i></a>
