...
<div class="rows">	
                ...
                <div class="caixa">
				 <div class="p-2 py-1 bg-title text-light text-uppercase  d-flex justify-content-space-between">
					...
					<form name="busca" action="{{route('admin.movimento.verMovimento')}}" method="get">                         
                        <div class="px-2 pt-2">
							  ...
							  <div class="rows">
                                        ...
                                        <div class="col-2 mb-2">	
                                                <label class="text-label d-block text-branco">Origem do Movimento {{$filtro->origem_movimento}}</label>
					...
					<div class="caixa"> 
						...
						<div>
							<strong class="text-entrada">
								<span class="tt">Qtde Entrada:</span>{{$qtde_entrada}}
								<span class="tt">Valor Entrada:</span>R$ {{$soma_entrada}}
							</strong>
						</div>
					</div>
				</div>
					...
					<div class="caixa"> 
						...
						<div>
							<strong class="text-saida">
								<span class="tt">Qtde Saída: </span>{{$qtde_saida}}
								<span class="tt">Valor Saída: </span>R$ {{$soma_saida}}
							</strong>
						</div>
					</div>
				</div>
					...
					<div class="caixa">
						...
						<div>							
							<strong class="text-estoque">
								<span class="tt">Saldo:</span>{{$qtde_entrada - $qtde_saida}}
