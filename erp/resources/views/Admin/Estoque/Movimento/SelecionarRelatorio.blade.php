...
<div class="rows">	
                ...
                <div class="caixa">
					...
					<form name="busca" action="{{route('admin.movimento.imprimir')}}" method="get">                        
                        <div class="px-2 pt-2">
							  ...
							  <div class="rows">
                                        ...
                                        <div class="col-3">	
                                            ...
                                            <select class="form-campo" name="tipo_relatorio">
                                            	<option value="entradas">Entradas Avulsas</option>
                                            	<option value="saidas">Saídas Avulsas</option>
                                            	<option value="movimento_geral">Movimentação Geral</option>
                                            	<option value="movimento_produto">Movimento do Produto</option>                                            
											</select>
                                        </div>
