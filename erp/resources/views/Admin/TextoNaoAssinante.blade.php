...
use App\Models\Assinatura;
 ...
 @php
	$vencimento         =  somarData(auth()->user()->empresa->assinatura->data_aquisicao, 15);
    $dias_restante      =  diferencaDataEmDias($vencimento, hoje()) ;
 @endphp
 <span class="text-center msg msg-amarelo position-fixed right top tempo">
	<span>
		<small>Seu plano de demonstração acaba em <b>{{ $dias_restante}} dias</b>  <a href="{{route('admin.assinatura.assinar')}}" class="btn btn-outline-azul btn-pequeno d-inline-block"> Quero Assinar</a></small>
	</span>
...
<div class="topo d-flex justify-content-space-between center-middle">
	...
	<a href="" class="icouser fas fa-user-circle">dsd</a>
	@php 
