            ...
            <div class="caixa">
				...
				<div class="rows pt-3 pb-4">					
					...
					<div class="col-4">	
                       ...
                       <div class="group-btn">
                        	<input type="text"  id="desc_fornecedor" class="form-campo">
                            <input type="hidden" name="fornecedor_id" id="fornecedor_id" >
							<a href="javascript:;" onclick="abrirModal('#modalCadFornecedor')" class="btn btn-azul btn-circulo ml-1 fas fa-plus" title="Inserir novo Serviço"></a>
                		</div>
                    </div>
                    ...
                    <div class="col-2">	
                        ...
                        <div class="group-btn">
                            <input type="text"  id="desc_tipo_despesa" class="form-campo">
                            <input type="hidden" name="tipo_despesa_id"   id="tipo_despesa_id" >
					...
					<div class="col-3 mb-3">
						<label class="text-label">Data Emissão</label>
						 <input type="date" name="data_lancamento" required id="data_lancamento" value="{{$despesa->data_lancamento ?? hoje() }}"  class="form-campo">												
					</div>	
					...
					<div class="col-3 mb-3">
                        ...
                        <div class="col-3 validated">	
                            ...
                            <input type="date" name="primeiro_vencimento" value="{{hoje()}}" id="primeiro_vencimento" class="form-campo data-input">
                        </div>
                        
                        <div class="col-3">	
                            <label class="text-label d-block ">Qtde Repetição</label>
                            <input type="number" min="1" name="repete" id="repete" value="1" class="form-campo">
                        </div>
