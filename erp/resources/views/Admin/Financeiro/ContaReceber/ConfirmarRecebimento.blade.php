            ...
            <div class="caixa">
				...
				<div class="rows pt-3 pb-4">
					...
					<div class="col-2 mb-3">
						...
						<input type="text"  readonly="readonly" readonly="readonly" value="{{ $contareceber->valor }}"    class="form-campo mascara-float">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Total Juros</label>
						<input type="text"   readonly="readonly" readonly="readonly" value="{{ $contareceber->total_juros }}"    class="form-campo mascara-float">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Total Multa</label>
						<input type="text"   readonly="readonly" readonly="readonly" value="{{ $contareceber->total_multa}}"    class="form-campo mascara-float">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Total Desconto</label>
						<input type="text"   readonly="readonly" readonly="readonly" value="{{ $contareceber->total_desconto }}"    class="form-campo mascara-float">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Total Recebido</label>
						<input type="text"  readonly="readonly" readonly="readonly" value="{{ $contareceber->total_recebido }}"    class="form-campo mascara-float">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Total Restante</label>
						<input type="text"   readonly="readonly" readonly="readonly" value="{{ $contareceber->total_restante }}"    class="form-campo mascara-float">												
					</div>
				...
				<div class="rows pt-3 pb-4">
                    ...
                    <select name="conta_corrente_id" class="form-campo">
                       @foreach($contas as $conta) 
                        	<option value="{{$conta->id}}" {{$contareceber->conta_corrente_id==$conta->id ? 'selected' : ''}}>{{$conta->descricao}}</option>  
                       @endforeach                                                  
                    </select>
                 </div>
                 ...
                 <div class="col-4">	
                    ...
                    <select name="classificacao_financeira_id" class="form-campo">
                       @foreach($classificacoes as $c) 
                        	<option value="{{$c->id}}" {{$contareceber->classificacao_financeira_id==$c->id ? 'selected' : ''}}>{{$c->codigo}} - {{$c->descricao}}</option>  
                       @endforeach                                                  
                    </select>
                 </div>
					...
					<div class="col-2 mb-3">
						...
						<input type="text" name="valor_original" id="valor_original" onkeyup="atualizaValor()" required  value="{{ $contareceber->total_restante }}"    class="form-campo mascara-float">												
					</div>
								 
					<div class="col-2 mb-3">
						<label class="text-label">Valor Liquido</label>
						<input type="text" name="valor_liquido" required  readonly id="valor_a_receber" value="{{ $contareceber->total_restante }}"    class="form-campo mascara-float">												
					</div>	
					<div class="col-2 mb-3">
...
function listarBandeiras(){
	var id = $("#forma_pagto_teste_id").val();
	if(id == 3){
		alert("teste");
	}
}
