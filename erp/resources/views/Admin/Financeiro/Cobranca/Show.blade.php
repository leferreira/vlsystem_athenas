				...
				<div class="rows pt-3 pb-4">
					<div class="col-2 mb-3">
						<label class="text-label">Data Pagamento</label>
						 <input type="date" name="data_pagamento" readonly="readonly" value="{{ $fatura->pagamento->data_pagamento }}"  readonly class="form-campo">												
					</div>
										
					<div class="col-4 mb-3">
						<label class="text-label">Forma de Pagamento</label>
						<input type="text"  readonly="readonly"  value="{{ $fatura->pagamento->forma_pagto->forma_pagto }}" class="form-campo">	
					</div>	
					<div class="col-2 mb-3">
						<label class="text-label">Número Documento</label>
						<input type="text" name="numero_documento" readonly="readonly" value="{{ $fatura->pagamento->numero_documento }}"  class="form-campo">												
					</div>
					
					<div class="col-4 mb-3">
						<label class="text-label">Observação</label>
						<input type="text" name="observacao" readonly="readonly" value="{{ $fatura->pagamento->observacao }}"class="form-campo">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Juros</label>
						<input type="text" name="juros" value="0" readonly="readonly" value="{{ $fatura->pagamento->juros }}" class="form-campo">												
					</div>
					<div class="col-2 mb-3">
						<label class="text-label">Multa</label>
						<input type="text" name="multa" value="0" readonly="readonly" value="{{ $fatura->pagamento->multa }}" class="form-campo">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Desconto</label>
						<input type="text" name="desconto" value="0" readonly="readonly" id="desconto" value="{{ $fatura->pagamento->desconto }}"  class="form-campo">												
					</div>				 
					<div class="col-3 mb-3">
						<label class="text-label">Valor a Pagar</label>
						<input type="text" name="valor_a_receber" readonly="readonly" id="valor_a_receber" value="{{ $fatura->pagamento->valor_recebido }}"    class="form-campo">												
					</div>					
					 <div class="caixa p-2">                   
