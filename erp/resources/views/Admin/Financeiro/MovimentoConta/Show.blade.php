				...
				<div class="rows pt-3 pb-4">
					<div class="col-2 mb-3">
						<label class="text-label">Data Pagamento</label>
						 <input type="date" name="data_pagamento" readonly="readonly" value="{{ $contareceber->recebimento->data_recebimento ?? null }}"  readonly class="form-campo">												
					</div>
										
					<div class="col-4 mb-3">
						<label class="text-label">Forma de Pagamento</label>
						<input type="text"  readonly="readonly"  value="{{ $contareceber->recebimento->forma_pagamento->forma_pagto ?? null}}" class="form-campo">	
					</div>	
					<div class="col-2 mb-3">
						<label class="text-label">Número Documento</label>
						<input type="text" name="numero_documento" readonly="readonly" value="{{ $contareceber->recebimento->numero_documento ?? null }}"  class="form-campo">												
					</div>
					
					<div class="col-4 mb-3">
						<label class="text-label">Observação</label>
						<input type="text" name="observacao" readonly="readonly" value="{{ $contareceber->recebimento->observacao ?? null }}"class="form-campo">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Juros</label>
						<input type="text" name="juros"  readonly="readonly" value="{{ $contareceber->recebimento->juros ?? null}}" class="form-campo mascara-float">												
					</div>
					<div class="col-2 mb-3">
						<label class="text-label">Multa</label>
						<input type="text" name="multa" readonly="readonly" value="{{ $contareceber->recebimento->multa ?? null}}" class="form-campo mascara-float">												
					</div>
					
					<div class="col-2 mb-3">
						<label class="text-label">Desconto</label>
						<input type="text" name="desconto" readonly="readonly" id="desconto" value="{{ $contareceber->recebimento->desconto ?? null}}"  class="form-campo mascara-float">												
					</div>				 
					<div class="col-3 mb-3">
						<label class="text-label">Valor a Pagar</label>
						<input type="text" name="valor_a_receber" readonly="readonly" id="valor_a_receber" value="{{ $contareceber->recebimento->valor_recebido ?? null }}"    class="form-campo mascara-float">												
					</div>					
					 <div class="caixa p-2">                   
