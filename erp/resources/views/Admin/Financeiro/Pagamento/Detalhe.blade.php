...
<div class="rows">
	...
	<div class="col-12">
		 <div class="caixa">
           <span class="p-2 bg-title text-light text-uppercase  text-branco justify-content-space-between d-flex">
				<span class="h5 mb-0 d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Pagamento: <b class="text-vermelho"> {{$pagamento->id}}</b> </span>
				<div class="d-flex">
					<a href="{{route('admin.pagamento.index')}}" class="btn btn-azul btn-pequeno ml-1" title="Voltar"><i class="fas fa-arrow-left"></i> </a>
	...
	<div class="col-12 mt-4">
            ...
            <span class="p-2 bg-title text-light text-uppercase h5 mb-0 text-branco"><i class="far fa-list-alt"></i> Dados do Pagamento</span>
