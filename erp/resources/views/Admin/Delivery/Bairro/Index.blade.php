...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de Bairros </span>
						<div>
							<a href="{{route('admin.deliverybairro.create')}}" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            <thead>
                                    <tr>
                                       ...
                                       <th align="center">Valor de repasse motoboy:</th>
                          ...
                          @foreach($bairros as $b)                                     
                             <tr>
                                ...
                                <td align="left">{{$b->valor_entrega}}</td>
							    <td align="left">{{$b->valor_repasse}}</td>										
                                <td align="center"><a href="{{route('admin.deliverybairro.edit', $b->id)}}" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
                                <td align="center">
                                <a href="#" onclick="confirm('Tem Certeza?') ? document.getElementById('apagar{{$b->id}}').submit() : '';" class="d-inline-block btn btn-vermelho btn-circulo btn-pequeno"><i class="fas fa-trash-alt"></i></a>
                                    <form action="{{route('admin.deliverybairro.destroy', $b->id)}}" method="POST" id="apagar{{$b->id}}">
