		...
		<div class="lista">
				...
				<thead>
					<tr> 
						<th align="left" style="text-transform:uppercase;padding:15px 10px;font-size:16px">
							Relação de Títulos a Receber Agrupado por Cliente
						</th>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border" style="margin-bottom:10px">
				...
				<tr class="tbody thead">
					<th>Cliente</th>
					<td colspan="9" class="border-left"> {{$l->cliente->nome_razao_social}} </td>
				</tr>	
					...
					<tr class="thead"> 
						...
						<th align="center" class="border-bottom border-top">Cliente</th> 
				...
				@endphp
					<tr style="text-transform:uppercase">
						...
						<td class="border-bottom-traco" align="center"><p>{{$v->cliente->nome_razao_social}}</p></td>
