	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="10" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE CONTAS A RECEBER</th>
					</tr>
					<tr class="thead"> 
				...
				@foreach($lista as $v)	
					<tr style="text-transform:uppercase">
						...
						<td class="border-bottom" align="center"><p>{{$v->cliente->nome_razao_social}}</p></td>
