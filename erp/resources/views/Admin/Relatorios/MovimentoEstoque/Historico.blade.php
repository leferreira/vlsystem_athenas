		...
		<div class="lista">
				...
				<thead>
					<tr> 
						<th align="left" style="text-transform:uppercase;padding:15px 10px;font-size:16px">
							Relatório de Movimentação de Estoque de Produto
						</th>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0" class="border" style="margin-bottom:10px">						
				...
				<tr class="tbody thead">
					<th align="right" style="padding-bottom:10px">Produto</th>
					<td colspan="7" class="border-left" style="padding-bottom:10px;padding-top:5px">{{$retorno->produto->nome}}</td>
				</tr>
					<tr class="thead"> 
						  <th align="center" class="border-bottom border-top">Id</th>
                          <th align="center" class="border-bottom border-top">Data</th>
                          <th align="left" class="border-bottom border-top">Produto</th>
                          <th align="center" class="border-bottom border-top">Valor</th>
                          <th align="center" class="border-bottom border-top">qtde</th>
                          <th align="center" class="border-bottom border-top">Subtotal</th>
                          <th align="center" class="border-bottom border-top">Tipo</th>
                          <th align="center" class="border-bottom border-top">Descrição</th>
                          
					</tr>
				
				<tbody class="tbody thead">	
				@foreach($retorno->lista as $m)	
					<tr style="text-transform:uppercase" class="rows">
						<td class="" align="center">{{$m->id}}</td>
						<td class="" align="center">{{databr($m->data_movimento)}}</td>
						<td class="" align="center">{{$m->produto->nome ?? "--"}}</td> 
						<td class="" align="center">{{$m->valor_movimento}}</td>											
						<td class="" align="center">{{$m->qtde_movimento}}</td>											
						<td class="" align="center">{{$m->subtotal_movimento}}</td>											
						<td class="" align="center">{{$m->tipoMovimento->tipo_movimento ?? "--"}}</td>											
						<td class="" align="center">{{$m->descricao}}</td>						
