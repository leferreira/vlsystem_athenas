	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="11" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE CONTAS A PAGAR</th>
					</tr>
					<tr class="thead"> 
						<th align="left" class="border-bottom">Emissão</th> 
						<th align="left" class="border-bottom">Vencimento</th> 
						...
						<th align="center" class="border-bottom">Total Recebido</th>
						<th align="center" class="border-bottom">Total Restante</th>
				...
				@foreach($lista as $v)	
					<tr style="text-transform:uppercase">
						<td class="border-bottom" align="left">{{databr($v->data_emissao)}}</td>
						<td class="border-bottom" align="left">{{databr($v->data_vencimento)}}</td>
						<td class="border-bottom" align="center"><p>{{$v->descricao}}</p></td>
						<td class="border-bottom" align="center"><p>{{$v->fornecedor->razao_social ?? "--"}}</p></td>
						<td class="border-bottom" align="center"><p>{{$v->valor}}</p></td>				 
						<td class="border-bottom" align="center"><p>{{$v->total_recebido}} </p>	</td>	
						<td class="border-bottom" align="center"><p>{{$v->total_restante}} </p>	</td>	
						<td class="border-bottom" align="center"><p>{{$v->total_juros}} </p>	</td>	
						<td class="border-bottom" align="center"><p>{{$v->total_multa}} </p>	</td>
						<td class="border-bottom" align="center"><p>{{$v->total_desconto}} </p>	</td>		
						<td class="border-bottom" align="center"><p>{{$v->status->status}} </p>	</td>	
					</tr>
				@endforeach
