		...
		<div class="lista">
				...
				<thead>
					<tr> 
						<th align="left" style="text-transform:uppercase;padding:15px 10px;font-size:16px">
							Relação de Títulos a Receber Agrupado por Emissão
						</th>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border" style="margin-bottom:10px">
				...
				<tr class="tbody thead">
					<th>Data Emissão</th>
					<td colspan="10" class="border-left"><?php echo databr($l->data); ?></td>
				</tr>	
						
                   				
					<tr class="thead"> 
					    <th align="left" class="border-bottom border-top">Emissão</th>  
					    <th align="left" class="border-bottom border-top">Vencimento</th> 
				...
				@endphp
					<tr style="text-transform:uppercase">
						...
						<td class="border-bottom-traco" align="left">{{databr($v->data_vencimento)}}</td>
