	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="5" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE VENDA POR FORMA de PAGTO: de {{databr($filtro->recebimento01)}} a {{databr($filtro->recebimento02)}}</th>
					</tr>
					<tr class="thead"> 
						<th align="center" class="border-bottom">Forma Pagamento</th>
				...
				@endphp
					...
					<tr style="text-transform:uppercase">
    					<td class="border-bottom"  align="center">{{ $c->forma->forma_pagto}}</td>	
    					...
    					<td class="border-bottom"  align="center">{{ formataNumeroBr($c->juros)  }}	</td>
				...
				@endforeach
					<tr class="thead" style="background:#f5f5f5">
    					...
    					<td class="border-bottom"  align="center">{{ formataNumeroBr($soma_juros)  }}	</td>
