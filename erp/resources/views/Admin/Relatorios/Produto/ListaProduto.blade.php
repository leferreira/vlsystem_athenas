	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="6" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE PRODUTOS</th>
					</tr>
					<tr class="thead"> 
						<th align="left" class="border-bottom">ID</th>
						<th align="center" class="border-bottom">Descrição</th>  
						<th align="center" class="border-bottom">Preço Custo</th>										  
						<th align="center" class="border-bottom">Preço Venda</th>
						<th align="center" class="border-bottom">Estoque</th>
						<th align="left" class="border-bottom">Código Barra</th> 
					</tr>
				</thead>
				...
				@foreach($lista as $v)	
					<tr style="text-transform:uppercase">
						...
						<td class="border-bottom" align="center"><p>{{$v->nome}}</p></td>
						<td class="border-bottom" align="center"><p>{{$v->valor_custo}}</p></td>				 
						<td class="border-bottom" align="center"><p>{{$v->valor_venda}} </p>	</td>					 
						<td class="border-bottom" align="center"><p>{{$v->estoque->quantidade ?? '--'}}</p>	</td>
						<td class="border-bottom" align="left">{{$v->codigo_barra}}</td>
					</tr>
				@endforeach
