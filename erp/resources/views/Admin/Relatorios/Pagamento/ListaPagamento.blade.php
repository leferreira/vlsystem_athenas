	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="10" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE PAGAMENTOS</th>
					</tr>
					<tr class="thead"> 
				...
				@foreach($lista as $v)	
					<tr style="text-transform:uppercase">
						...
						<td class="border-bottom" align="center"><p>{{$v->descricao_pagamento}}</p></td>
						<td class="border-bottom" align="left">{{databr($v->data_pagamento)}}</td>						
						...
						<td class="border-bottom" align="center"><p>{{$v->valor_pago}} </p>	</td>
