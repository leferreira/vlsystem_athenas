	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="6" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE MOVIMENTOS</th>
					</tr>
					<tr class="thead"> 
						<th align="center" class="border-bottom">Id</th>
                       <th class="left" class="border-bottom">Lançamento</th>
                       <th align="center" class="border-bottom">Data Emissão</th>
                       <th align="center" class="border-bottom">Data Compensação</th>
                       <th align="center" class="border-bottom">Valor</th>
                       <th align="center" class="border-bottom">Tipo Movimento</th>>						
					</tr>
				</thead>
				...
				@foreach($lista as $lancamento)	
					<tr style="text-transform:uppercase">
						<td class="border-bottom"  align="center">{{ $lancamento->id }}</td>
                       <td class="border-bottom"  align="left"> <small class="d-block text-azul">{{ $lancamento->historico }}</small></td>
                       <td class="border-bottom"  align="center">{{ databr($lancamento->data_emissao) }}</td>
                       <td class="border-bottom"  align="center">{{ databr($lancamento->data_compensacao) }}</td>
                       <td class="border-bottom"  align="center">{{ $lancamento->valor }}</td>
                      	<td class="border-bottom"  align="center">{{ $lancamento->tipo_movimento }}</td>
