	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="7" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE VENDAS PDV: de {{databr($filtro->data1)}} a {{databr($filtro->data2)}}</th>
					</tr>
					<tr class="thead"> 
				...
				@foreach($lista as $c)	
					<tr style="text-transform:uppercase">
    					...
    					<td class="border-bottom"  align="center">{{formataNumeroBr($c->valor_venda)  }}	</td>
    					<td class="border-bottom"  align="center">{{ formataNumeroBr($c->valor_acrescimo)  }}	</td>
    					<td class="border-bottom"  align="center">{{ formataNumeroBr($c->desconto_valor)  }}	</td>
    					<td class="border-bottom"  align="center">{{ formataNumeroBr($c->valor_liquido)  }}	</td>
    					<td class="border-bottom"  align="center">{{isset($c->vendedor->nome)? substr($c->vendedor->nome, 0, 30) : "--"}}</td> 
