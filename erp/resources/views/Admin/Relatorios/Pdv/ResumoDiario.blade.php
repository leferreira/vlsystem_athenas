	...
	<div class="corpo">
		<div class="lista">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="border">
				<thead>
					<tr> 
						<th colspan="4" class="border-bottom" style="text-transform:uppercase;padding:15px 4px;font-size:16px">RELATORIO  DE VENDA DIÁRIA PDV: de {{databr($filtro->data1)}} a {{databr($filtro->data2)}}</th>
					</tr>
					<tr class="thead"> 
