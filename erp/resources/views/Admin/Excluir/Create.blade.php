							...
							<legend>Itens da Compra</legend>
							 <div class="rows">	
                                        ...
                                        <div class="col-2">	
                                            ...
                                            <input type="text" name="valor"  value="10" id="valor" class="form-campo mascara-float">
                                        </div>
                                        
                                        <div class="col-2">	
                                            <label class="text-label d-block ">Subtotal</label>
                                            <input type="text" name="subtotal" disabled value="10" id="subtotal" class="form-campo mascara-float ">
                                        </div>
