...
<div class="rows">	
    ...
    <div class="caixa">
		<div class="p-2 py-1 bg-title text-light text-uppercase text-branco d-flex justify-content-space-between">
			<span class="h5 mb-0 d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de suplemento </span>
		</div>				
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                          ...
                          @foreach($lista as $cat)                                     
                             <tr>
                                ...
                                <td align="center"><a href="{{route('admin.suplemento.edit', $cat->id)}}" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
                                <td align="center">
                                ...
                                <a href="#" onclick="confirm('Tem Certeza?') ? document.getElementById('apagar{{$cat->id}}').submit() : '';" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i></a>
                                    <form action="{{route('admin.suplemento.destroy', $cat->id)}}" method="POST" id="apagar{{$cat->id}}">
