            ...
            <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    @foreach($lista as $l)
						<tr>
							...
							<td align="center">{{$l->curso->curso}}</td>
							<td align="center"><a href="{{route('ead.aula.edit', $l->id)}}" class="d-inline-block btn btn-verde btn-circulo btn-pequeno" title="Matricula"><i class="fas fa-edit"></i></td>
