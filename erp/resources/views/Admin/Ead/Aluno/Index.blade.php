...
<div class="rows">	
           ...
           <div class="p-2 py-1 bg-title text-light text-uppercase text-branco d-flex justify-content-space-between">
				<span class="d-flex center-middle  h5 mb-0"><i class="far fa-list-alt mr-1"></i> Lista de Alunos </span>
				<div>
					<a href="{{route('ead.aluno.create')}}" class="btn btn-azul ml-1 d-inline-block" title=" Adicionar novo"><i class="fas fa-plus-circle"></i></a>
				...
				<div class="px-2 pt-2"> 
					...
					<div class="mostraFiltro bg-padrao mt-2 p-2 radius-4">
						 <div class="rows p-3">	
							<div class="col-6">
									<span class="text-label text-branco">Aluno</span>
            ...
            <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    @foreach($lista as $l)
						<tr>
							...
							<td align="center"><a href="{{route('ead.aluno.matricular', $l->id)}}"  title="Matricula">Matricular</a></td>

							<td align="center"><a href="{{route('ead.aluno.edit', $l->id)}}" class="d-inline-block btn btn-verde btn-circulo btn-pequeno" title="Editar"><i class="fas fa-edit"></i></a></td>
							 <td align="center">
