			...
			<div class="rows">
					<div class="col-2">	
                     ...
                     <div class="col-2">	
                         ...
                         <input type="text" name="desconto_per"  id="desconto_per" value="{{($orcamento->valor_desconto) ?? old('valor_desconto')}}"  class="form-campo mascara-float">
                     </div>
                     ...
                     <div class="col-2">	
                         ...
                         <input type="text" name="totalorcamento" disabled  id="totalorcamento" value="{{($orcamento->valor_orcamento) ?? old('valor_orcamento')}}" class="form-campo">
                     </div>
