				...
				<div class="rows">					
						 ...
						 <div class="border radius-4 p-2">
                           <div class="rows">
								...
								<?php 
								    $imagem = ($usuario->foto) ?? "assets/admin/img/img-usuario.svg";
							     ?>							
                           ...
                           <div class="col-8">
							   <div class="rows">
									...
									<div class="col-6 mb-3">
											...
											<input type="text" name="telefone" value="{{isset($usuario->telefone) ? $usuario->telefone : old('telefone')}}"  class="form-campo mascara-celular">
									</div> 
